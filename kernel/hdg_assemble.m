...
%     
%     absDiag = full(absDiag);
%     absOffDiag = full(absOffDiag);
%     
%     load('thisRun.mat','hybridd','dtt');
%     filename = ['diagDom_scheme_',hybridd,'_dt_',num2str(dtt),'.mat'];
%     save(filename,'absDiag','absOffDiag');
% end
