...
void AVflux_ns(double *f, double *f_udg, double *pg, double *udg, double *udg_ref, double *avField, meshstruct &mesh, masterstruct &master, appstruct &app, double *param,
...
//                     DG_2_p1CG(avField_p1CG, avField_DG, mesh, master, ndims);
                ...
                case 7:     // Like case 4, but with solution at previous DIRK stage for AV field
                    flux_AVfrozen_ns2d(f, f_udg, pg, udg, udg_ref, app, param, time, ng, nc, ncu, nd, ncd, computeJacobian);
                    break;
