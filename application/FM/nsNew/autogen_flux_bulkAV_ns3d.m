...
F_AV = [0; txx_AV; tyx_AV; tzx_AV; txx_AV.*u + txy_AV.*v + txz_AV.*w + (gam.*r.*av./Pr_AV).*Tx; 0; txy_AV; tyy_AV; tzy_AV; tyx_AV.*u + tyy_AV.*v + tyz_AV.*w + (gam.*r.*av./Pr_AV).*Ty; 0; txz_AV; tyz_AV; tzz_AV; tzx_AV.*u + tzy_AV.*v + tzz_AV.*w + (gam.*r.*av./Pr_AV).*Tz];
