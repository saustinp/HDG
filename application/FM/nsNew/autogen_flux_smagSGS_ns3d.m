...
% - Deviatoric SGS viscous stress tensor model: Smagorinksy
...
% C_d = 0.16;
% Values for C_d:
% 1) E. Garnier, N. Adams, P. Sagaut, Large Eddy Simulation for Compressible
% Flows: 0.1-0.2 depending on flow. Theoretical values of 0.148 and 0.18
% can be obtained under different hypotheses.
% 2) T.B. Gatski, J.P. Bonnet, Compressibility, Turbulence and High Speed
% Flow: 0.16 (suggested by Yoshizawa), 0.012 (from calibration with DNS)
% 3) CHARLES: 0.18
