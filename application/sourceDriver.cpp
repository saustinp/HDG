...
void sourceDriver(double * s,double * s_UDG, double * pg, double * UDG, double * UDG_ref, appstruct &app, double * param,
                  double time, Int* ndims, int computeJacobian, int numPoints)
{
    ...
    switch (app.appname) {
        case 0:
            source_eulerNEW(s, s_udg, pg, udg, udg_ref, app, param, time, numPoints, nc, ncu, nd, ncd, computeJacobian);
            break;
        case 1:
            source_nsNEW(s, s_udg, pg, udg, udg_ref, app, param, time, numPoints, nc, ncu, nd, ncd, computeJacobian);
            break;
        case 3:
            source_ransSANEW(s, s_udg, pg, udg, udg_ref, app, param, time, numPoints, nc, ncu, nd, ncd, computeJacobian);
            break;
        default:
