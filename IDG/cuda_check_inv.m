function cuda_check_inv(mesh, master, app, SH, UDG, UH, uinf, param, time, fc_q, fc_u, tdep, f2e, nn, nme, nmf)
...
Ru = cuda_Ru_face(Ru, UDG, mesh.dgnodes, uinf(1:ncu), tempfn, tempfg, shapfn, shapfg, param, time, f2e, nn, nmf);
app.fbou = 'ldgfbou';
app.fhat = 'ldgfhat';
