 ...
 *
 * _coder_flux_digaso_matlab_api.c
 *
 * Code generation for function '_coder_flux_digaso_matlab_api'
 *
 */

/* Include files */
#include "_coder_flux_digaso_matlab_api.h"
#include "flux_digaso_matlab.h"
#include "flux_digaso_matlab_data.h"
#include "rt_nonfinite.h"

/* Function Declarations */
static real_T (*b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                   const emlrtMsgIdentifier *parentId))[180000];

static void b_emlrt_marshallOut(const real_T u[1620000], const mxArray *y);

static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *f_udg,
                                   const char_T *identifier))[1620000];

static real_T (
    *d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                        const emlrtMsgIdentifier *parentId))[1620000];
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *f,
                                 const char_T *identifier))[180000];

static void emlrt_marshallOut(const real_T u[180000], const mxArray *y);
...
static real_T (*m_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                   const emlrtMsgIdentifier *msgId))[180000];

static real_T (*n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                   const emlrtMsgIdentifier *msgId))[1620000];
...
static void b_emlrt_marshallOut(const real_T u[1620000], const mxArray *y)
{
  static const int32_T iv[2] = {1, 1620000};
                                   ...
                                   const char_T *identifier))[1620000]
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(f_udg), &thisId);
  emlrtDestroyArray(&f_udg);
  return y;
}
...
static void emlrt_marshallOut(const real_T u[180000], const mxArray *y)
{
  static const int32_T iv[2] = {1, 180000};
  emlrtMxSetData((mxArray *)y, (void *)&u[0]);
  emlrtSetDimensions((mxArray *)y, &iv[0], 2);
}
...
static real_T (*m_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                   const emlrtMsgIdentifier *msgId))[180000]
{
  static const int32_T dims[2] = {1, 180000};
  real_T(*ret)[180000];
  int32_T iv[2];
  boolean_T bv[2] = {false, false};
  emlrtCheckVsBuiltInR2012b((emlrtConstCTX)sp, msgId, src, "double", false, 2U,
                            (const void *)&dims[0], &bv[0], &iv[0]);
  ret = (real_T(*)[180000])emlrtMxGetData(src);
...
static real_T (*n_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
                                   const emlrtMsgIdentifier *msgId))[1620000]
{
  static const int32_T dims[2] = {1, 1620000};
  real_T(*ret)[1620000];
  int32_T iv[2];
  boolean_T bv[2] = {false, false};
  emlrtCheckVsBuiltInR2012b((emlrtConstCTX)sp, msgId, src, "double", false, 2U,
                            (const void *)&dims[0], &bv[0], &iv[0]);
  ret = (real_T(*)[1620000])emlrtMxGetData(src);
  emlrtDestroyArray(&src);
  return ret;
}
...
void flux_digaso_matlab_api(const mxArray *const prhs[11], int32_T nlhs,
                            const mxArray *plhs[2])
{
  ...
  f = emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_0), "f");
  f_udg = c_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_1), "f_udg");
  ...
  flux_digaso_matlab(&st, *f, *f_udg, *pg, *udg, *param, b_time, ng, nc, ncu,
                     nd, ncd);
  /* Marshall function outputs */
  emlrt_marshallOut(*f, prhs_copy_idx_0);
  plhs[0] = prhs_copy_idx_0;
  if (nlhs > 1) {
    b_emlrt_marshallOut(*f_udg, prhs_copy_idx_1);
    plhs[1] = prhs_copy_idx_1;
  }
}

/* End of code generation (_coder_flux_digaso_matlab_api.c) */
