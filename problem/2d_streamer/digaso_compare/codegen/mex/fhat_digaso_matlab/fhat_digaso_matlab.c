...
void fhat_digaso_matlab(const emlrtStack *sp, real_T fh[135000],
                        ...
                        real_T ng, real_T nc, real_T nch, real_T nd, real_T ncd)
{
  real_T d;
  int32_T i;
  int32_T i1;
  ...
  fhat_streamer2d(&fh[0], &fh_udg[0], &fh_uh[0], &pg[0], &udg[0], &uh[0],
                  &nl[0], &param[0], i, i1, i2, i3, i4, i5);
}

/* End of code generation (fhat_digaso_matlab.c) */
