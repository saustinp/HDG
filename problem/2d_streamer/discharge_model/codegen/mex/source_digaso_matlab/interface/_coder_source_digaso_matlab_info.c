 ...
 *
 * _coder_source_digaso_matlab_info.c
 *
...
/* Include files */
#include "_coder_source_digaso_matlab_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name",
                emlrtMxCreateString("source_digaso_matlab"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("/Users/saustin/Documents/HDG/problem/2d_streamer/"
                          "digaso_compare/source_digaso_matlab.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739216.99510416668));
  xResult =
...
/* End of code generation (_coder_source_digaso_matlab_info.c) */
