 ...
 *
 * _coder_fhat_digaso_matlab_api.c
 *
 * Code generation for function '_coder_fhat_digaso_matlab_api'
 *
 */

/* Include files */
#include "_coder_fhat_digaso_matlab_api.h"
#include "fhat_digaso_matlab.h"
...
static real_T (*c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *fh_udg,
                                   ...
                                   const char_T *identifier))[1215000]
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(fh_udg), &thisId);
  emlrtDestroyArray(&fh_udg);
  return y;
}
...
void fhat_digaso_matlab_api(const mxArray *const prhs[14], int32_T nlhs,
                            const mxArray *plhs[3])
{
  ...
  fh_udg = c_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_1), "fh_udg");
  ...
  uh = emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_5), "uh");
  nl = g_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_6), "nl");
  param = i_emlrt_marshallIn(&st, emlrtAlias(prhs_copy_idx_7), "param");
  b_time = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[8]), "time");
  ng = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[9]), "ng");
  nc = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[10]), "nc");
  nch = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[11]), "nch");
  nd = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[12]), "nd");
  ncd = k_emlrt_marshallIn(&st, emlrtAliasP(prhs[13]), "ncd");
  /* Invoke the target function */
  fhat_digaso_matlab(&st, *fh, *fh_udg, *fh_uh, *pg, *udg, *uh, *nl, *param,
                     b_time, ng, nc, nch, nd, ncd);
  /* Marshall function outputs */
  emlrt_marshallOut(*fh, prhs_copy_idx_0);
  plhs[0] = prhs_copy_idx_0;
  if (nlhs > 1) {
    b_emlrt_marshallOut(*fh_udg, prhs_copy_idx_1);
...
/* End of code generation (_coder_fhat_digaso_matlab_api.c) */
