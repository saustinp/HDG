function mesh = mkmesh_rect2(m,n,porder,parity,xrect,elemtype,nodetype)
...
i1 = p(:,1)<=0; p(i1,1) = loginc(p(i1,1),3);
i1 = p(:,1)>=0; p(i1,1) = logdec(p(i1,1),3);
i1 = p(:,2)<=0; p(i1,2) = loginc(p(i1,2),3);
i1 = p(:,2)>=0; p(i1,2) = logdec(p(i1,2),3);
