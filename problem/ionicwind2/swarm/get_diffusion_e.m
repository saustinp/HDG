function diffusion_coefficent = get_diffusion_e(E, N)
    ...
    % Electron diffusion
    step1 = 0.5*(tanh(1000*(log_EN+1))+1);
    step = 0.5*(tanh(1000*(log_EN-1.9))+1);
    diffusion_coefficent = (1-step1).*0.0417*N +step1.*((1-step).*(3.477702502838188e23*log_EN + 1.4137092744995724e24)  + step.*(4.6338371114205166e24*log_EN + -6.700654851204797e24));
