...
mesh.dgnodes(:,3,:) = 0.0125*dist;
[UDG,UH] = hdg_solve(master,mesh,app,UDG,UH,SH);
figure(2); clf; scaplot(mesh,UDG(:,1,:),[],2,0); axis off; 
...
s = ucg2udg(udg2ucg(divergence(UDG1{4},href), cgent2dgent, rowent2elem), cgelcon);
